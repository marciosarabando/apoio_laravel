...
<div class="input-field">
	<input type="text" name="marca_modelo" class="upper validade" value="{{ isset($registro->marca_modelo) ? $registro->marca_modelo : '' }}">
	<label>Marca / Modelo</label>
</div>

<div class="input-field">
	<input type="text" name="nr_serie" class="upper validade" value="{{ isset($registro->nr_serie) ? $registro->nr_serie : '' }}">
